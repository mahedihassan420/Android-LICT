...
public class ReceiveSmsActivity extends Activity implements OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int pos, long id) {
        try {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(ReceiveSmsActivity.this).create();
            alertDialog.setTitle("Original Message");
            alertDialog.setMessage(smsMessageStr);
            alertDialog.show();
        } catch (Exception e) {
            e.printStackTrace();
        }
